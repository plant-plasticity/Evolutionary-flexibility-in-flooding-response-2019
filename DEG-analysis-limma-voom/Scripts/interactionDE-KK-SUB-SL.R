...
## Metadata options
metaFile <- "SUB-SL-meta.csv" #Name of metadata file in csv format.
doFilter <- T #F
...
countsFile <- "SUB-SL-est-counts.txt" #Name of metadata file
...
## Output
outDir = "SUB-SL-interaction/"
dir.create(outDir, showWarnings=T)

sink('SUB-SL-interaction/Output.txt')

geneListsDir = "SUB-SL-interaction/GeneLists"
dir.create(geneListsDir, showWarnings=T)
#
imgDir = "SUB-SL-interaction/images/"
...
cont.matrix= makeContrasts(
    ...
    "SL-HAIRY-TOT"=TOTSUBHAIRYROOT-TOTCONHAIRYROOT,
    "SL-HAIRY-TRA"=TRASUBHAIRYROOT-TRACONHAIRYROOT,
    "SL-HAIRY-INRNA"=INRNASUBHAIRYROOT-INRNACONHAIRYROOT,
    "SL-HAIRY-RS"=RSSUBHAIRYROOT-RSCONHAIRYROOT,
    
    "SL-sample-int-HAIRY-TRA-TOT"= (TRASUBHAIRYROOT-TOTSUBHAIRYROOT)-(TRACONHAIRYROOT-TOTCONHAIRYROOT),
    "SL-sample-int-HAIRY-INRNA-TOT"= (INRNASUBHAIRYROOT-TOTSUBHAIRYROOT)-(INRNACONHAIRYROOT-TOTCONHAIRYROOT),
    "SL-sample-int-HAIRY-INRNA-TRA"= (INRNASUBHAIRYROOT-TRASUBHAIRYROOT)-(INRNACONHAIRYROOT-TRACONHAIRYROOT),

    "SL-sample-int-HAIRY-RS-TOT"= (RSSUBHAIRYROOT-TOTSUBHAIRYROOT)-(RSCONHAIRYROOT-TOTCONHAIRYROOT),
    "SL-sample-int-HAIRY-RS-INRNA"= (RSSUBHAIRYROOT-INRNASUBHAIRYROOT)-(RSCONHAIRYROOT-INRNACONHAIRYROOT),
    "SL-sample-int-HAIRY-RS-TRA"= (RSSUBHAIRYROOT-TRASUBHAIRYROOT)-(RSCONHAIRYROOT-TRACONHAIRYROOT),
    
    "SL-ROOT-TOT"=TOTSUBSLROOT-TOTCONSLROOT,
    "SL-ROOT-TRA"=TRASUBSLROOT-TRACONSLROOT,
    "SL-ROOT-INRNA"=INRNASUBSLROOT-INRNACONSLROOT,
    
    "SL-sample-int-ROOT-TRA-TOT"= (TRASUBSLROOT-TOTSUBSLROOT)-(TRACONSLROOT-TOTCONSLROOT),
    "SL-sample-int-ROOT-INRNA-TOT"= (INRNASUBSLROOT-TOTSUBSLROOT)-(INRNACONSLROOT-TOTCONSLROOT),
    "SL-sample-int-ROOT-INRNA-TRA"= (INRNASUBSLROOT-TRASUBSLROOT)-(INRNACONSLROOT-TRACONSLROOT),
    
    "SL-SHOOT-TOT"=TOTSUBSLSHOOT-TOTCONSLSHOOT,
    "SL-SHOOT-TRA"=TRASUBSLSHOOT-TRACONSLSHOOT,
    "SL-SHOOT-INRNA"=INRNASUBSLSHOOT-INRNACONSLSHOOT,
    
    "SL-sample-int-SHOOT-TRA-TOT"= (TRASUBSLSHOOT-TOTSUBSLSHOOT)-(TRACONSLSHOOT-TOTCONSLSHOOT),
    "SL-sample-int-SHOOT-INRNA-TOT"= (INRNASUBSLSHOOT-TOTSUBSLSHOOT)-(INRNACONSLSHOOT-TOTCONSLSHOOT),
    "SL-sample-int-SHOOT-INRNA-TRA"= (INRNASUBSLSHOOT-TRASUBSLSHOOT)-(INRNACONSLSHOOT-TRACONSLSHOOT),
    ...
    "SL-tissue-int-ROOT-SHOOT-TOT"=(TOTSUBSLROOT-TOTSUBSLSHOOT)-(TOTCONSLROOT-TOTCONSLSHOOT),
    "SL-tissue-int-ROOT-SHOOT-TRA"=(TRASUBSLROOT-TRASUBSLSHOOT)-(TRACONSLROOT-TRACONSLSHOOT),
    "SL-tissue-int-ROOT-SHOOT-INRNA"=(INRNASUBSLROOT-INRNASUBSLSHOOT)-(INRNACONSLROOT-INRNACONSLSHOOT),
    
    "SL-tissue-int-ROOT-HAIRY-TOT"=(TOTSUBSLROOT-TOTSUBHAIRYROOT)-(TOTCONSLROOT-TOTCONHAIRYROOT),
    "SL-tissue-int-ROOT-HAIRY-TRA"=(TRASUBSLROOT-TRASUBHAIRYROOT)-(TRACONSLROOT-TRACONHAIRYROOT),
    "SL-tissue-int-ROOT-HAIRY-INRNA"=(INRNASUBSLROOT-INRNASUBHAIRYROOT)-(INRNACONSLROOT-INRNACONHAIRYROOT),
    
    "SL-2x2x2-int-ROOT-HAIRY-INRNA-TOT"=((INRNASUBSLROOT-INRNASUBHAIRYROOT)-(INRNACONSLROOT-INRNACONHAIRYROOT))-((TOTSUBSLROOT-TOTSUBHAIRYROOT)-(TOTCONSLROOT-TOTCONHAIRYROOT)),
    "SL-2x2x2-int-ROOT-HAIRY-TRA-TOT"=((TRASUBSLROOT-TRASUBHAIRYROOT)-(TRACONSLROOT-TRACONHAIRYROOT))-((TOTSUBSLROOT-TOTSUBHAIRYROOT)-(TOTCONSLROOT-TOTCONHAIRYROOT)),
    "SL-2x2x2-int-ROOT-HAIRY-TRA-INRNA"=((TRASUBSLROOT-TRASUBHAIRYROOT)-(TRACONSLROOT-TRACONHAIRYROOT))-((INRNASUBSLROOT-INRNASUBHAIRYROOT)-(INRNACONSLROOT-INRNACONHAIRYROOT)),
    "SL-2x2x2-int-ROOT-SHOOT-INRNA-TOT"=((INRNASUBSLROOT-INRNASUBSLSHOOT)-(INRNACONSLROOT-INRNACONSLSHOOT))-((TOTSUBSLROOT-TOTSUBSLSHOOT)-(TOTCONSLROOT-TOTCONSLSHOOT)),
    "SL-2x2x2-int-ROOT-SHOOT-TRA-TOT"=((TRASUBSLROOT-TRASUBSLSHOOT)-(TRACONSLROOT-TRACONSLSHOOT))-((TOTSUBSLROOT-TOTSUBSLSHOOT)-(TOTCONSLROOT-TOTCONSLSHOOT)),
    "SL-2x2x2-int-ROOT-SHOOT-TRA-INRNA"=((TRASUBSLROOT-TRASUBSLSHOOT)-(TRACONSLROOT-TRACONSLSHOOT))-((INRNASUBSLROOT-INRNASUBSLSHOOT)-(INRNACONSLROOT-INRNACONSLSHOOT)),
